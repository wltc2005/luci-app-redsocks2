...
translatef("A modified version of redsocks. It can redirect TCP connections which are blocked via proxy automatically with or without a blacklist.")
)
...
o.rmempty=false
o.datatype="uinteger"
o=s:option(Flag,"blacklist_enabled",translate("Enable Blacklist"),translate("Specify destination IP addresses which must be redirect to redsocks2."))
o.rmempty=false
o=s:option(Value,"black_port",translate("Blacklist Port"))
o.datatype="uinteger"
...
o=s:option(Value,"dest_port",translate("Destination Port"))
o.datatype="uinteger"
s=m:section(TypedSection,"redsocks2_tcpdns",translate("TCPDNS Settings"))
s.anonymous=true
o=s:option(Flag,"tcpdns_enabled",translate("Enable TCP DNS"),translate("DNS over TCP"))
o.rmempty=false
o=s:option(Value,"tcpdns_ip",translate("Local IP"))
o.datatype="ip4addr"
o=s:option(Value,"tcpdns_port",translate("TCPDNS Port"))
o.datatype="uinteger"
o=s:option(Value,"tcpdns1",translate("DNS Server 1"))
o.datatype="ip4addr"
o=s:option(Value,"tcpdns2",translate("DNS Server 2"))
o.datatype="ip4addr"
o=s:option(Value,"tcpdns_timeout",translate("Timeout"))
o.datatype="uinteger"
o.rmempty=false
o=s:option(Value,"black_port",translate("Blacklist Port"))
o.datatype="uinteger"
